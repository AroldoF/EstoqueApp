export function InputField({children, id, type, value,className, handleChange, ...props}){
    return(
        <div className="flex flex-col gap-3">
            ...
            className="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:border-[var(--color-border-focus)] focus:ring-1 focus:ring-[var(--color-border-focus)]"/>
        </div>
    );
}